...
app.get('/api', (req, res) => {
  res.json({
    ...
    endpoints: {
      ...
      'POST /api/analyze': 'Run OpenAI analysis (body: { resource_id } or { resource_ids: [...] })',
      ...
      '--- AI AGENT (needs OPENAI_API_KEY) ---': '---',
      'POST /api/agent/scan': '🤖 FULL AI SCAN — OpenAI analyzes all resources, auto-kills zombies, queues rest for approval',
      'POST /api/agent/kill': '💀 AI KILL MODE — OpenAI decides what to kill and kills it immediately',
